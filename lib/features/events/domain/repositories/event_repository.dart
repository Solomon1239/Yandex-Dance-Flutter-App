...
abstract interface class EventRepository {
  ...
  /// Стрим мероприятий, где пользователь в [DanceEvent.participantIds]
  /// (явно записался). Создатель попадает сюда только после «Записаться
  /// как участник». Используется в профиле и в «Ближайшие».
  ...
  /// документ в Firestore с готовыми URL'ами. Список участников
  /// изначально пустой — запись через [joinEvent]. Возвращает уже созданное
